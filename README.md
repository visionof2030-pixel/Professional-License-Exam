...
const questions = [
  ...
  },
  {
    ...
    "answer": 3,
    "explanations": {
      "correct": "النقطتان الرأسيتان (:) بعد القول لأنها تسبق كلاماً منقولاً مباشراً، وعلامة التعجب (!) في نهاية الجملة لأنها تعبر عن الانفعال والإعجاب. هذا الترقيم يناسب طبيعة الجملة الانفعالية التي تعبر عن الإعجاب الشديد. يساعد في نقل المشاعر والأحاسيس بشكل واضح للقارئ.",
      "wrong1": "الفاصلة (،) لا تصلح بعد القول لأنها لا تعبر عن بداية كلام منقول مباشر. النقطة (.) لا تناسب نهاية الجملة لأنها لا تعبر عن الانفعال والإعجاب. هذا الترقيم يجعل الجملة باهتة ولا ينقل المشاعر المرتبطة بها.",
      "wrong2": "الفاصلة (،) غير مناسبة بعد القول، وعلامة الاستفهام (؟) لا تليق بنهاية الجملة لأنها ليست سؤالاً. هذا الترقيم يشوه المعنى ويوحي بأن الجملة استفهامية وليست تعجبية. لا يتناسب مع طبيعة الجملة التعبيرية الانفعالية.",
      "wrong3": "النقطتان الرأسيتان مناسبة لكن النقطة العادية لا تعبر عن الانفعال في نهاية الجملة. الجملة تحتاج لعلامة تعجب لنقل مشاعر الإعجاب والانبهار. النقطة العادية تجعل المعنى مجرداً من المشاعر والعاطفة."
    }
  },
  {
    "id": 35,
  ...
  },
  {
    ...
    "answer": 0,
    "explanations": {
      "correct": "الضمير (الهاء) في 'أمامه' يعود على 'الهدف' لأنه أقرب مذكور يمكن أن يعود عليه الضمير. النص يتحدث عن هدف غير متاح أمام المتعلم، والضمير يعود على هذا الهدف. القواعد النحوية تقتضي أن الضمير يعود على أقرب مذكور مناسب في الجملة.",
      "wrong1": "الضمير لا يعود على 'المتعلم' لأن المتعلم هو الفاعل وليس المفعول به في هذه الجملة. لو عاد الضمير على المتعلم لكان التعبير 'أمامه' يعني أمام المتعلم نفسه وهذا لا معنى له. السياق يدل على أن الهدف هو الذي ليس متاحاً أمام المتعلم.",
      "wrong2": "الضمير لا يعود على 'الوصول' لأن الوصول هو عملية وليس كياناً يمكن أن يكون غير متاح أمام المتعلم. التعبير 'الوصول غير متاح أمامه' لا يتناسب مع السياق اللغوي. التركيز في الجملة على الهدف وليس على عملية الوصول.",
      "wrong3": "الضمير لا يعود على 'متاح' لأن 'متاح' صفة وليس اسماً يمكن أن يعود عليه الضمير. الصفات لا يمكن أن يعود عليها الضمير بشكل مباشر في التركيب النحوي. 'متاح' تتبع الهدف في الإعراب والوظيفة النحوية."
    }
  },
  {
    "id": 37,
  ...
  },
  {
    ...
    "answer": 1,
    "explanations": {
      "correct": "الجملة الثانية كتبت فيها الضاد والظاء بشكل صحيح حيث كلمة 'الظلام' بالظاء وكلمة 'تضيق' بالضاد. تم التمييز بين الحرفين وفق قواعد الكتابة الصحيحة. جميع الكلمات كتبت بحروفها الصحيحة وفق أصول اللغة.",
      "wrong1": "الجملة الأولى تحتوي على خطأ في كلمة 'ضاهره' حيث الصواب 'ظاهره' بالظاء. الخطأ في التمييز بين الضاد والظاء يغير معنى الكلمة. هناك خلط بين الحرفين في مواقع تحتاج لدقة.",
      "wrong2": "الجملة الثالثة تحتوي على كلمة 'أضعف' التي كتبت بالضاد والصواب 'أظعف' بالظاء. الخطأ في كتابة الحرف يغير المعنى المقصود من الجملة. يحتاج لمراجعة قواعد كتابة الظاء والضاد.",
      "wrong3": "الجملة الرابعة لا تحتوي على الظاء لكن كلمة 'الغضب' كتبت بالضاد بشكل صحيح. مع ذلك لا يمكن اعتبارها الإجابة الصحيحة لأن السؤال عن الجملة التي كتبت فيها كلا الحرفين بشكل صحيح. تحتوي على الضاد فقط وليس الظاء."
    }
  },
  {
    "id": 50,
  ...
  },
  {
    ...
    "answer": 2,
    "explanations": {
      "correct": "التخريب الرقمي هو المصطلح الأنسب لأنه يتضمن العبث بالأنظمة الرقمية وإتلافها. يشير إلى التعديل غير المصرح به على المحتوى الرقمي أو تصميم المواقع. يعتبر شكلاً من أشكال التخريب الإلكتروني الذي قد يندرج تحت الجرائم المعلوماتية.",
      "wrong1": "الجريمة المعلوماتية مصطلح أوسع يشمل مختلف أنواع الجرائم الإلكترونية. لا يحدد النوع الدقيق للجريمة المذكورة في السؤال. يعتبر تصنيفاً عاماً وليس توصيفاً دقيقاً للحالة.",
      "wrong2": "السرقة الإلكترونية تركز على الاستيلاء على البيانات أو المعلومات بغرض الانتفاع. لا تنطبق على حالة التغيير أو الإتلاف المذكورة في السؤال. تتعلق بالاستيلاء وليس بالإتلاف.",
      "wrong3": "الإتلاف المعلوماتي ليس مصطلحاً شائعاً أو معتمداً في مجال الأمن الإلكتروني. قد يكون وصفاً عاماً ولكن ليس التصنيف التقني الدقيق. لا يستخدم بشكل راسخ في الأدبيات المتخصصة."
    }
  },
  {
    "id": 58,
  ...
  {
    "id": 60,
    "q": "وصفك خبيرا تربويا في بناء المناهج وطلب منك اختيار التنظيم الذي يهتم بحاجات الطلاب أكثر من ميولهم واهتماماتهم، ويسمح للمعلم بالاستعانة بآخرين لمساعدته، ويكون عدد الطلاب الذين يتعامل معهم قليلا، فأي تنظيمات المناهج الآتية يكون مناسبا أكثر من غيره?",
    "options": ["المحوري", "المواد المنفصلة", "المواد المترابطة", "المجالات العلمية"],
    "answer": 0,
    "explanations": {
      "correct": "التنظيم المحوري هو الأنسب لأنه يركز على حاجات الطلاب الأساسية ويسمح بالمرونة في التدريس. يتميز بصغر عدد الطلاب في المجموعة الواحدة مما يسمح باهتمام فردي أكبر. يتيح للمعلم الاستعانة بمتخصصين آخرين لتغطية الجوانب المختلفة للمحور.",
      "wrong1": "تنظيم المواد المنفصلة يركز على التخصص وليس بالضرورة على حاجات الطلاب. يعتمد على الفصل بين المواد وقد لا يسمح بالتكامل المطلوب. لا يوفر بالضرورة مجموعات صغيرة أو مرونة في الاستعانة بآخرين.",
      "wrong2": "تنظيم المواد المترابطة يهتم بالربط بين المواد ولكن ليس بالضرورة بحاجات الطلاب. التركيز على العلاقات بين المواد أكثر من التركيز على الحاجات الفردية. قد لا يوفر المجموعات الصغيرة المطلوبة.",
      "wrong3": "تنظيم المجالات العلمية يركز على التصنيف الأكاديمي للمعرفة. يعتمد على التخصصات العلمية أكثر من اهتمامه بالحاجات الفردية للطلاب. قد لا يوفر المرونة في العمل مع مجموعات صغيرة."
    }
  },
  {
    "id": 61,
  ...
  {
    "id": 64,
    "q": "الأستاذ أحمد زرع قيمة المواطنة السعودية في نفوس المتعلمين، ووضع الأهداف الآتية لهذة القيمة: (1) أن يشارك الطالب في ندوة عن جهود المملكة العربية السعودية في خدمة الحرمين (2) أن يتمثل القدوة الحسنة لأسرته في بناء الحس الوطني (3) أن يقدر الطالب دور المملكة العربية السعودية في خدمة المسجد الأقصى (4) أن يبدي الطالب إهتمامه لحديث معلمه عن جهود المملكة العربية السعودية في خدمة الحجاج ,الترتيب المناسب للأهداف من الأدنى إلى الأعلى لتحقيق القيمة وفق تصنيف كراثول هو :",
    "options": ["٤٢٣١", "١٣٢٤", "١٢٣٤", "٢١٣٤"],
    "answer": 0,
    "explanations": {
      "correct": "الترتيب الصحيح هو ٤٢٣١ وفقاً لتصنيف كراثول للمجال الوجداني، حيث يبدأ من الاستقبال ثم الاستجابة ثم التقدير ثم التنظيم. الهدف (4) يمثل الاستقبال، (2) يمثل الاستجابة، (3) يمثل التقدير، (1) يمثل التنظيم. هذا التسلسل يتدرج من أبسط مستويات التعلم الوجداني إلى أعلاها.",
      "wrong1": "الترتيب ١٣٢٤ غير صحيح لأنه يخلط بين المستويات المختلفة للتعلم الوجداني. لا يتبع التسلسل المنطقي من البسيط إلى المعقد. يضع أهدافاً متقدمة قبل تحقيق الأهداف الأساسية.",
      "wrong2": "الترتيب ١٢٣٤ يبدأ بالمستوى الأعلى وهو المشاركة الفعالة قبل تحقيق المستويات الدنيا. يتعارض مع مبدأ التدرج في بناء القيم من الاستقبال إلى التنظيم. لا يراعي البناء المتدرج للميول والاتجاهات.",
      "wrong3": "الترتيب ٢٣١٤ يخلط بين مستويات مختلفة ولا يتبع التسلسل الهرمي الصحيح. يبدأ بالاستجابة قبل الاستقبال مما يتعارض مع المنطق التربوي. لا يحقق التكامل المنطقي بين مستويات التعلم الوجداني."
    }
  },
  {
    "id": 65,
  ...
  {
    "id": 69,
    "q": "قدم المعلم لطلابه نشاطاً يشتمل على مجموعات مثلثات مختلفة الزوايا وطلب منهم قياس الزوايا ايجاد مجموعها وملاحظة النتائج ، ومنه توصل الطلاب إلى حقيقة (مجموع زوايا المثلث 180 درجة) ، عليه فإن طريقة التدريس المطبقة هي:",
    "options": ["الاستنباط", "الاستقراء", "العرض العملي", "حل المشكلات"],
    "answer": 1,
    "explanations": {
      "correct": "الطريقة المستخدمة هي الاستقراء لأنها تبدأ من أمثلة specificة (المثلثات المختلفة) إلى rule عام (مجموع الزوايا). الطلاب يتوصلون إلى التعميم من خلال ملاحظة الأمثلة والاستنتاج. تنمي مهارات الملاحظة والاستنتاج والتفكير العلمي المنظم.",
      "wrong1": "الاستنباط يبدأ من القاعدة العامة إلى التطبيقات الخاصة. يعاكس الطريقة المذكورة التي تبدأ من الأمثلة إلى القاعدة. يعتمد على تطبيق القواعد وليس اكتشافها.",
      "wrong2": "العرض العملي يركز على توضيح المعلومة من قبل المعلم. لا يشترط أن يتوصل الطلاب إلى النتيجة بأنفسهم. يعتبر طريقة عرضية وليس اكتشافية.",
      "wrong3": "حل المشكلات يبدأ من مشكلة محددة ويبحث عن حلها. النشاط المذكور ليس مشكلة بل عملية استقصاء لاكتشاف rule. يركز على معالجة موقف problematic وليس على الاستقراء."
    }
  },
  {
    "id": 70,
  ...
  },
  {
    ...
    "answer": 3,
    "explanations": {
      "correct": "استراتيجية كاروسل (Carousel) هي استراتيجية تعلم نشط حديثة تعتمد على تنقل الطلاب بين محطات تعلم مختلفة. تتيح للطلاب التعلم من خلال الحركة والنقاش والعمل الجماعي في بيئة تفاعلية. تنمي مهارات التفكير الناقد والتعاون وحل المشكلات من خلال التناوب بين الأنشطة المتنوعة.",
      "wrong1": "بيسك (PECS) هو نظام اتصال بصور يستخدم principalmente مع الأطفال ذوي التوحد. لا يعتبر استراتيجية تعلم نشط بالمعنى العام للاستراتيجيات الصفية. يركز على التواصل وليس على التعلم النشط في السياق الصفي العادي.",
      "wrong2": "فراير (Frayer) نموذج لتنظيم المفاهيم وليس استراتيجية تعلم نشط حديثة. يركز على تحليل المفلمات من خلال تحديد التعريف والخصائص والأمثلة. يعتبر أداة تنظيم معرفي وليس استراتيجية تعلم نشط متكاملة.",
      "wrong3": "H4 ليس استراتيجية تعلم نشط معروفة في الأدبيات التربوية. قد يشير إلى مصطلحات تقنية أو برمجيات ولكن ليس استراتيجية تدريس. لا يتوافق مع الاستراتيجيات الحديثة المعتمدة في التعلم النشط."
    }
  },
  {
    "id": 86,
