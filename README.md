...
const questions = [
  ...
  "answer": 0,
  "explanations": {
    "correct": "الترتيب الصحيح: ٤١٣٢. التحليل: الهدف (4) «يبدي الطالب اهتمامه لحديث معلمه...» يمثل مستوى الاستقبال (Receiving) لأنه يشير إلى الانتباه والتهيؤ السمعي/الانتباه للمعلومة. الهدف (1) «يشارك الطالب في ندوة...» يندرج في مستوى الاستجابة (Responding) لأنه يمثل مشاركة فعلية وتفاعلًا سلوكيًا مع المعلومة. الهدف (3) «يقدر الطالب دور المملكة...» يقع تحت مستوى التقدير/القيمة (Valuing) حيث يَحول الطالب المعلومات إلى موقف ذو قيمة وأهمية. والهدف (2) «يتمثل القدوة الحسنة لأسرته...» يمثل المستوى الأعلى (Characterization) لأنه يشير إلى تجلّي القيمة في سلوك مستمر وملامح شخصية يَحكم بها الطالب أفعاله، أي أصبحت قيمة متأصلة تقود سلوكه. هذا التسلسل يتوافق مع بنية كراثول التي تنتقل من الانتباه إلى التفاعل ثم التقدير ثم الاستقرار والسلوك القيمي الداخلي. 1",
    "wrong1": "الخيار ٤٢٣١ غير صحيح لأنّه يضع (2) في مرتبة أعلى من المتوقع. بتفصيل: يضع هذا الخيار (4) كأدنى مستوى وهو صحيح فقط إذا اعتبرنا الاهتمام استقبالًا، لكنه يضع (2) بعد ذلك في مستوى الاستجابة بينما (1) و(3) وضعا بصورة تجعل (3) في مستوى التقدير ثم (1) في التنظيم؛ لكن (1) مشاركة في ندوة هي استجابة وليست تنظيمًا للقيم، و(2) كون قدوة للأسرة أقرب إلى مستوى التوصيف/التجذر في القيم (Characterization)، لذلك التسلسل مخالف لتدرج كراثول المنطقي. 2",
    "wrong2": "الخيار ١٣٢٤ غير منطقي لأنّه يضع (1) كأدنى مستوى بينما (1) «المشاركة في ندوة» هي سلوك تفاعلي واضح (Responding) وليست مستوى استقبال خام. كذلك يجعل (3) بعد ذلك (Valuing) ثم (2) في مستوى التنظيم، مع أن (2) «يتمثل القدوة الحسنة» يتجاوز مجرد تنظيم للقيم إلى أن تكون القيم سلوكية مستمرة (Characterization). بهذا يكون التسلسل متعارضًا مع مفاهيم المستوىين الأعلىين في كراثول.",
    "wrong3": "الخيار ١٢٣٤ يضع الأهداف تصاعديًا بترتيب 1→2→3→4، وهذا غير دقيق لأن البداية (1) ليست أقل مستوى وجدانياً من (4). بمعنى آخر، هذا الخيار يفترض أن المشاركة في ندوة هي البداية البسيطة، بينما الاهتمام بسماع المعلم (4) أهدأ وأبسط ويقع فعليًا في مرتبة الاستقبال. أيضًا وضع (2) قبل (3) يفترض أن تمثيل القدوة (2) أقل من مجرد تقدير دور المملكة في خدمة الأقصى (3)، وهذا تناقض منطقي لأن التمثيل كسلوك متكرر ومستمر يعتبر أعلى مستوى من مجرد إظهار التقدير."
    }
  },
  {
    "id": 65,
